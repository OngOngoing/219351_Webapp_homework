...
/* *INDENT-OFF* */
static const char *launcher_array[] = {  "ssh",  "rsh",  "fork",  "slurm",  "ll",  "lsf",  "sge",  "none",  "persist",  NULL };
static const char *rmk_array[] = {  "none",  "slurm",  "ll",  "lsf",  "sge",  "pbs",  NULL };
static HYD_status(*launcher_init_array[])(void) = {  HYDT_bsci_launcher_ssh_init,  HYDT_bsci_launcher_rsh_init,  HYDT_bsci_launcher_fork_init,  HYDT_bsci_launcher_slurm_init,  HYDT_bsci_launcher_ll_init,  HYDT_bsci_launcher_lsf_init,  HYDT_bsci_launcher_sge_init,  HYDT_bsci_launcher_none_init,  HYDT_bsci_launcher_persist_init,  NULL };
static HYD_status(*rmk_init_array[])(void) = {  HYDT_bsci_rmk_none_init,  HYDT_bsci_rmk_slurm_init,  HYDT_bsci_rmk_ll_init,  HYDT_bsci_rmk_lsf_init,  HYDT_bsci_rmk_sge_init,  HYDT_bsci_rmk_pbs_init,  NULL };
/* *INDENT-ON* */
